 ...
 */
public class CourseListViewAdapter extends ArrayAdapter<Course> implements Filterable  {
    Activity activity;
    List<Course> coursesFilterList;
    private final List<Course> coursesList;
    Course clickedCourse;
    CoursesFilter coursesFilter;
    final String TAG = CourseListViewAdapter.class.getSimpleName();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        try {
            holder.image.setImageBitmap(MediaStore.Images.Media.getBitmap(getContext().getContentResolver(), c.getImage()));
        }
        catch (IOException e){
            e.printStackTrace();
        }
        ...
        try {
            Bitmap icon = MediaStore.Images.Media.getBitmap(getContext().getContentResolver(), c.getImage());
    ...
    public CourseListViewAdapter(Activity activity, int resource, List<Course> list){
